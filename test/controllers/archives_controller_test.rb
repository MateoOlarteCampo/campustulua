...
class ArchivesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create archive" do
    assert_difference('Archive.count') do
      post archives_url, params: { archive: { course_id: @archive.course_id, description: @archive.description, name: @archive.name } }
    end
  ...
  test "should update archive" do
    patch archive_url(@archive), params: { archive: { course_id: @archive.course_id, description: @archive.description, name: @archive.name } }
